...
The `caterpillar()` and `envelope()` functions plot output for vectors of parameter nodes, 
and `comparecat()`, `comparedens()` and `overlayenvelope()` functions allow comparison
between multiple models or parameter vectors.
